    ...
    <div className="space-y-6 md:space-y-8 font-[Outfit] pb-10">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 px-2 md:px-0">
        ...
        <div className="flex gap-2 w-full lg:w-auto items-center justify-end">
          ...
          <button onClick={() => fetchAttendance(page)} className="p-3 md:p-4 bg-white border border-gray-100 rounded-xl md:rounded-2xl text-gray-400 hover:text-gray-900 shadow-sm active:scale-95 transition-all shrink-0">
      ...
      <div className="bg-white p-4 md:p-6 rounded-[1.5rem] md:rounded-[2rem] border border-gray-100/70 shadow-sm mx-2 lg:mx-0 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3 items-end">
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input 
              type="date" 
              className="w-full pl-10 pr-3 py-3 bg-gray-50/50 border border-gray-100 rounded-xl text-[10px] md:text-xs font-black uppercase outline-none"
              value={startDate}
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <select 
              className="w-full pl-10 pr-3 py-3 bg-gray-50/50 border border-gray-100 rounded-xl text-[10px] md:text-xs font-black uppercase outline-none appearance-none cursor-pointer text-gray-800"
              value={status}
      ...
      {totalPages > 1 && (
        <div className="flex justify-center items-center gap-3 pt-6 px-2">
          <button
