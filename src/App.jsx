...
import RegionalOfflineSyncMonitor from "./components/RegionalOfflineSyncMonitor"
 ...
 */}
          ...
          <Routes>
            ...
            <Route path="/usuario" element={<ProtectedRoute role="USUARIO"><UserLayout /></ProtectedRoute>}>
           ...
           {/* SUPERVISOR */}
            ...
            >
              ...
              <Route
                ...
                element={<Navigate to="/admin-regional/task-control" replace />}
